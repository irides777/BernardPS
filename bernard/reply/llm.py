...
class ReplyQuerySig(dspy.Signature):
    ...
    reply: str = dspy.OutputField(desc="The reply you designed to query user for completing data, your reply should be short and clear, and be consistent with dialogue in language")
...
class ReplyInformationConfirmSig(dspy.Signature):
    ...
    reply: str = dspy.OutputField(desc="The reply you designed to send to user for confirmation to information_need_check, not information in dialogue, your reply should be short and clear, and be consistent with dialogue in language")